...
namespace SnakeGame
{
    class Program
    {
        ...
        static void Menu()
        {
            ...
            while (!f)
            {
                Console.WriteLine("Game name: tip: Snake, Hero");
                ...
                {
                    Console.WriteLine("Eror 404 Game Name Not Found");
            ...
            if (name.ToLower() == "snake")
            {
                ...
                while (!valid)
                {
                    Console.WriteLine("choose Speed 1-100.");
                    var isint = int.TryParse(Console.ReadLine(), out speed);
                    if (!isint)
                    {
                        Console.WriteLine("Eror a valid number.");
                    }
                    else
                    {
                        valid = true;
